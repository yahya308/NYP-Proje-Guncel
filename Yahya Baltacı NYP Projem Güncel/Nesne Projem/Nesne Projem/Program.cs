...
namespace NesneyeYönelikProgramlamaProjem
{
    class Program
    {
        ...
        static void StringIslemleri()
        {
            ...
            string cumle = Console.ReadLine();   //Kullanıcıdan metin girdisi alınır.
...
//Bu class ta overloaded methotlar kullanılır.
...
public class BankaClass
{
    ...
    public string tc
    {
        ...
        set
        {//Tc kimlik numarasının tam 11 haneli olması gereklidir.
            if (value.Length == 11)
            {
                TC = value;
            }
...
public static class Collatz
{
    ...
    {   //3x+1 problemi
        ...
        long minRange = long.Parse(Console.ReadLine());

        Console.WriteLine("Lütfen deneme aralığı için maksimum değer giriniz:");
        long maxRange = long.Parse(Console.ReadLine());
